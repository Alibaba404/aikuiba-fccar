		...
		<nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
			<div class="site-navbar__header">
				<h1 class="site-navbar__brand">
					<a class="site-navbar__brand-lg">飞驰专车管理系统</a>
			...
			<div class="site-sidebar__inner">
				<el-menu :default-active="menuActiveName || 'home'" :collapse="sidebarFold" :collapseTransition="false"
					...
					<el-submenu index="组织管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						...
						<el-menu-item index="dept" v-if="isAuth(['ROOT', 'DEPT:SELECT'])"
							@click="$router.push({ name: 'Dept' })" ref="ABC">
							<SvgIcon name="company_fill" class="icon-svg" />
							<span slot="title">部门管理</span>
						</el-menu-item>
						<el-menu-item index="role" v-if="isAuth(['ROOT', 'ROLE:SELECT'])"
							@click="$router.push({ name: 'Role' })">
							<SvgIcon name="role_fill" class="icon-svg" />
							<span slot="title">角色管理</span>
						</el-menu-item>
						<el-menu-item index="user" v-if="isAuth(['ROOT', 'USER:SELECT'])"
					...
					<el-submenu index="运营管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						...
						<el-menu-item index="order" v-if="isAuth(['ROOT', 'ORDER:SELECT'])"
							@click="$router.push({ name: 'Order' })">
							<SvgIcon name="log" class="icon-svg" />
							<span slot="title">订单信息</span>
						</el-menu-item>
						<el-menu-item index="order" v-if="isAuth(['ROOT', 'COMMENT:SELECT'])"
							@click="$router.push({ name: 'Comment' })">
							<SvgIcon name="shoucangfill" class="icon-svg" />
							<span slot="title">订单评价</span>
						</el-menu-item>
						<el-menu-item index="voucher" v-if="isAuth(['ROOT', 'VOUCHER:SELECT'])"
							@click="$router.push({ name: 'Voucher' })">
							<SvgIcon name="tubiao" class="icon-svg" />
							<span slot="title">代金券</span>
						</el-menu-item>
						<el-menu-item index="monitoring" v-if="isAuth(['ROOT', 'MONITORING:SELECT'])"
					...
					<el-submenu index="规则管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						...
						<el-menu-item index="approval" v-if="isAuth(['ROOT', 'WORKFLOW:APPROVAL', 'FILE:ARCHIVE'])"
