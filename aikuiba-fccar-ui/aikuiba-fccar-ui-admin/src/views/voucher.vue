<template>
	<div v-if="isAuth(['ROOT', 'VOUCHER:SELECT'])">
		...
		>
			...
			<el-table-column prop="uuid" header-align="center" align="center" min-width="140" label="编号" />
			...
			<el-table-column prop="totalQuota" header-align="center" align="center" min-width="80" label="总数量" />
			<el-table-column prop="takeCount" header-align="center" align="center" min-width="00" label="已领取" />
			...
			<el-table-column header-align="center" align="center" width="280" label="操作">
				<template #default="scope">
					<el-button
						type="text"
						size="medium"
