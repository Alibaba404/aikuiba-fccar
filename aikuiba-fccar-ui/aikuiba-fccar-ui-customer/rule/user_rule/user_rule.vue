<template>
	<view class="page">
		...
		<view class="desc">本规则适用于通过飞驰专车代驾APP、飞驰专车代驾小程序等途径使用飞驰专车代驾功能及服务的全部乘客。</view>
		...
		<view class="desc">限制账号使用 ：限制违规人使用飞驰专车代驾发单功能的权利，限制过程中该账号仍可登陆查看账号信息，但无法通过飞驰专车代驾发单并享受代驾服务。</view>
